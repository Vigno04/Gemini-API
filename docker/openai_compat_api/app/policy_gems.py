...
def _build_specs(prefix: str) -> list[PolicyGemSpec]:
    common_rules = (
        ...
        f"For image editing/transformation, include marker {IMAGE_EDIT_MARKER} in the thinking process as soon as possible.\n"
        f"For generating new images from text, include marker {IMAGE_GENERATION_MARKER} in the thinking process as soon as possible.\n"
